...
%---------------------------------------------------------
  \cventry
    {Frontend Engineer, Mid-Level} % Job title
    {Convertium Pte. Ltd.} % Organization
    {Singapore, Singapore} % Location
    {Mar. 2025 - Apr. 2026} % Date(s)
    {
      \textbf{Achievements:}
      \vspace{1.5em}
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Lead and completed the frontend development of Income Insurance's marketing site (https://www.income.com.sg) over a 10 month period.}
        \item {Lead the UI development of National Gallery Singapore's e-commerce website.}
      \end{cvitems}
      \textbf{Responsibilities:}
      \vspace{1.5em}
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Built an old-school CSS/JS + React component library based on Figma designs which can be used with/without React.}
        ...
        \item {Technologies: TypeScript/JavaScript, React, RESTful APIs, SASS, Storybook.js, Liquid (for Shopify)}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Feb. 2021 - Dec. 2024} % Date(s)
    {
      ...
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Technologies: Python, Django, Docker, Kubernetes, PostgreSQL, TypeScript/JavaScript, React, Kalidokit (for motion tracking).}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Dec. 2018 - Dec. 2020} % Date(s)
    {
      ...
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Technologies: TypeScript/JavaScript, React, RxJS, WebSockets, LESS/SASS/BEM, Docker, CI/CD (Travis), Perl5, Node.js, Hapi.js, PostgreSQL.}
      \end{cvitems}
    }
