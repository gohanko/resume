  ...
  \cventry
    ...
    {Mar. 2025 - Apr. 2026} % Date(s)
    {
      ...
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Lead and completed the frontend development of Income Insurance's marketing site (see: https://www.income.com.sg/) over a 10 month period. Figma -> Component/Widget Library -> Page Templates -> Integration with MVC Backend.}
