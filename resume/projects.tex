  ...
  \cventry
    ...
    {Mar. 2025 - Feb. 2026} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {A marketing website for Income Insurance (https://www.income.com.sg/) built over a 10 month period.}
        \item {Led the frontend development end-to-end, building a CSS/JS + React component library based on Figma designs that can be used with or without React.}
        \item {Chose and applied Atomic Design methodology for the component library, ensuring long-term maintainability and consistency across the site.}
